...
public class AllMonthlyExpense extends HttpServlet 
{
	...
	else
	{
		...
		ArrayList<ExpdDTO> ar=indv.getAllMonthlyExpense((String)req.getSession().getAttribute("database"),month);
		
		ListIterator l=ar.listIterator();
		
		o.print("<!DOCTYPE html><html><head><title>All members Monthly Expense</title></head><body style=\"background-color:silver\" background=\"/Vinay_Expenditure/apics/beach.jpg\">");
		o.print("<center><img height=\"200px\" width=\"250px\" align=\"center\" alt=\"vinay lover\" src=\"/Vinay_Expenditure/tamanna.jpg\"><center>");
		o.print("<fieldset><legend>All members Monthly Expense..</legend>");
