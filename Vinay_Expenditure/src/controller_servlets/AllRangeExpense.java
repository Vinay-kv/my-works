...
import dao.AllMonthlyExpenseDAO;
import dao.IndividualMonthlyExpenseDAO;
import dto.ExpdDTO;

public class AllRangeExpense extends HttpServlet 
{
	...
	else
	{
		...
		AllMonthlyExpenseDAO indv=new AllMonthlyExpenseDAO();
		ArrayList<ExpdDTO> ar=indv.getAllRangeExpense((String)req.getSession().getAttribute("database"),date1, date2);
		
		ListIterator l=ar.listIterator();
		
		o.print("<!DOCTYPE html><html><head><title>All members duration Expense</title></head><body style=\"background-color:silver\" background=\"/Vinay_Expenditure/apics/beach.jpg\">");
		o.print("<center><img height=\"200px\" width=\"250px\" align=\"center\" alt=\"vinay lover\" src=\"/Vinay_Expenditure/tamanna.jpg\"><center>");
		o.print("<fieldset><legend>All members duration Expense..</legend>");
