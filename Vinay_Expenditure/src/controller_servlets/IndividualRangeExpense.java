...
public class IndividualRangeExpense extends HttpServlet 
{
	...
	else
	{
		...
		ArrayList<ExpdDTO> ar=indv.getIndividualRangeExpense((String)req.getSession().getAttribute("database"),name, date1, date2);
