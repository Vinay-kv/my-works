...
public class IndividualExpense extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		...
		else
		{
			...
			IndividualExpenseDAO indv=new IndividualExpenseDAO();
			String data=(String)req.getSession().getAttribute("database");
			ArrayList<ExpdDTO> ar=indv.getIndividualExpense(data,name);
			
			ListIterator l=ar.listIterator();
			
			o.print("<!DOCTYPE html><html><head><title>Individual all Expense</title></head><body style=\"background-color:silver\" background=\"/Vinay_Expenditure/apics/sunrise.jpg\">");
			o.print("<center><img height=\"200px\" width=\"250px\" align=\"center\" alt=\"vinay lover\" src=\"/Vinay_Expenditure/samu.jpg\"><center>");
			o.print("<fieldset><legend>Your's all Expense..</legend>");
